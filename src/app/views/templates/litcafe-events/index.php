...
<meta charset="utf-8">
    ...
    <title>Litcafe Events in Felicity 2019</title>
...
<body>
    <div class="container">
        <div class="nav-bars">
            <a href="/threads-events">
                <div class="nav-bar nav-bar-link">
                    Threads
                </div>
            </a>
            <a href="/litcafe-events">
            <div class="nav-bar nav-bar-active">
                LitCafe
            </div>
            </a>
            <a href="/pulsation-events">
            <div class="nav-bar nav-bar-link">
                Pulsation
            </div>
            </a>
            ...
            <a href="/culture-events">
            <div class="nav-bar nav-bar-link">
                Culture
            </div>
            </a>
            <a href="/zombie-zone-events">
            <div class="nav-bar nav-bar-link">
                Zombie Zone
            </div>
            </a>
        ...
        <div class="content">
            <div class="projector">
                For anyone and everyone who has a creative side and enjoys literature in any form. Dive into this world of fantasies and adventures!
            </div>
           <div class="filmstrip">
               <div class="boxes">
               ...
               <div class="panels">
                    <div class="film-pic">Escape The Room,
                        4-6PM, <br />
                        20th January
                    </div>                   
                    <div class="film-pic">Treasure Hunt, <br />
                                        5-7PM, <br />
                                        21st January
                    </div>                   
