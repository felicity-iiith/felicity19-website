...
body {
    ...
    background: url('felicity hero large.png') no-repeat;
    ...
    <div class="container">
        ...
        <div class="content">
           ...
           <div class="filmstrip">
               ...
               <div class="panels">
                    <div class="film-pic">A</div>                   
                    <div class="film-pic">B</div>                   
                    <div class="film-pic">C</div>                   
                    <div class="film-pic">D</div>                   
               </div>              
               <div class="boxes">
                    <div class="white-box"></div>
                    <div class="white-box"></div>
